# Testing Cookiecutter Sample guide installation
...
activate testing_cookiecutter_sample
```
...
To move beyond notebook prototyping, all reusable code should go into the `testing_cookiecutter_sample/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `testing_cookiecutter_sample` folder and use the modules inside your notebooks :
...
```python
from testing_cookiecutter_sample.utils.paths import data_dir
data_dir()
```
